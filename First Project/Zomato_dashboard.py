        ...
        if customer_id:
            ...
            if customers_data:
                ...
                if st.button("Update Customer"):
                    result = custom_obj.customer_update(customer_id, name, email, phone, location, is_premium, preferred_cuisine, average_rating)
                    st.success(result)
            else:
    ...
    if submenu == "View Restaurants":
        ...
        if restaurants_id:
            ...
            if restaurants_data:
                ...
                if st.button("Add Restaurants"):
                    result_ = res_.restaurants_update(restaurants_id, name, cuisine_type, location, owner_name, average_delivery_time,
